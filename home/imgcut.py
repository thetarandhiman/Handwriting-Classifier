def imgcut():    
    ...
    source_image_path = "/mnt/d/codes/Handwriting-Classifier/media/User1.png"
    destination_folder_path = "/mnt/d/codes/Handwriting-Classifier/training/imgsep/"
    ...
    # image = image.resize((    , fixed_height), PIL.Image.NEAREST)
